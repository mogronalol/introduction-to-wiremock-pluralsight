...
public class Demo3AnswerTest {
    ...
    public void shouldPayForBookingWithFraudCheck() {
        ...
        // When
        final BookingResponse bookingResponse = bookingService.payForBookingWithFraudCheck("1111",new CreditCard("1234-1234-1234-1234", LocalDate.of(2018, 2, 1), new BigDecimal("20.55")));
